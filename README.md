...
Device: CUDA (GPU)
Training Behavior:
Loss steadily decreases from ~10 → ~1.8
...
LR scheduler step applied

Evaluation:

Every 500 steps, model evaluated on train and validation splits
...
Occasionally produces repetition or minor logical drift (expected for small-scale LM)
Text Generation
...
Generated:
There was a small dragon. He was so friendly and curious. He wanted to explore the world but was scared. He asked a wise dragon for help, and the dragon told him how to stay safe while exploring.
